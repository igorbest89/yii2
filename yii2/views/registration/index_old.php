...
<head>
    ...
    <link rel="stylesheet" href="/css/A23/style.css">
    <link rel="stylesheet" href="/css/A23/responsive.css">
            ...
            <div class="create-photo-name">
                ...
                echo FileInput::widget([
                    ...
                    'pluginOptions' => [
                        ...
                        'initialPreview' => ($user->user_photo) ? [
                            Html::img($user->user_photo, ['width' => 200, 'maxHeight' => 200])
                        ] : false,
                ...
                <div class="create-column">
                    <div class="create-space-between">
                        <input id="registration-user-firstname-front" name="firstname" type="text"
                               class="input-base create-input234" placeholder="First name">
                        <input id="registration-user-middlename-front" name="middlename" type="text"
                               class="input-base create-input234" placeholder="Middle Name(optional)">
                    </div>
                    <div class="create-space-between">
                        <input id="registration-user-lastname-front" name="lastname" type="text"
                    ...
                    <div class="create-space-between">
                        <span class="choice-edit">
                            <select id="registration-user-gender-front" name="gender"
