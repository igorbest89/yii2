...
<body>
    <main class="main">
        <div class="professional-cv-template">
            ...
            <div class="professional-fifth-cv">
                <div class="preview-prof-six">
                    <div class="professional-fifth-container">
                        <aside class="right-part">
                            <div class="right-part-mask">
                                <div class="left-sidebar-background">
                                    <div class="left-sidebar-mask">
                                        <div class="professional-fifth-exp">
                                            <img src="/templates/A75/img/pro-big.png" alt="PRO" class="professional-fifth-exp__pro">
                                            <span class="icon-year-exp__years"><label></label><p class="prof-year-exp">Years Experience</p></span>
                                        </div>
                                        <div class="professional-fifth-image">
                                            <img src="/templates/A75/img/photo.png" alt="Profile" class="circle">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <section class="premium-sections section-contact-details">
                                    ...
                                    <span class="premium-phones">
                                        <img src="/templates/A75/img/icons/phone.svg" alt=""><p class="premium-phones__item"><?= $user->phone ?></p>
                                    </span>
                                    <span class="premium-phones">
                                        <img src="/templates/A75/img/icons/msg.svg" alt=""><p class="prof-sections__email"><?= $user->email ?></p>
                                    </span>
                                    <span class="premium-phones">
                                        <img src="/templates/A75/img/icons/planet.svg" alt=""><p class="prof-sections__addr"><?= $user->address ?></p>
                                    </span>
                                </section>
                        ...
                        <div class="premium-content">
                            <div class="container-premium">
                                <section class="professional-fourth-descr">
                                    ...
                                    <div class="prev-six-wrap">
                                        <img src="/templates/A75/img/icons/profile.svg" alt=""><p class="professional-fourth-descr__years"></p>
                                    </div>
                                </section>
    ...
    <?php $this->registerJsFile('/templates/A75/js/app.js'); ?>
</body>
