                        ...
                        <div class="professional-fourth-mask">
                            <div class="professional-fourth-container">
                                ...
                                <section class="professional-fourth-descr">
                                    <h1 class="professional-fourth-descr__title"></h1>
                            ...
                            <aside class="right-part">
                                <div class="container-right-sidebar">
                                    ...
                                    <section class="professional-fourth-descr-mob">
                                        <h1 class="professional-fourth-descr-mob__title"></h1>
                                        <h4 class="professional-fourth-descr-mob__prof">Quality Assurance, Product Manager, Business Analyst </h4>
                                        <p class="professional-fourth-descr-mob__years"><label></label></p>
                                        <hr>
                                    </section>
                                    <section class="premium-sections section-contact-details">
                                        ...
                                        <span class="premium-phones">
                                            <img src="/templates/A65/img/icons/phone.svg" alt=""><p class="premium-phones__item"></p>
                                        </span>
                                        <span class="premium-phones">
                                            <img src="/templates/A65/img/icons/msg.svg" alt=""><p class="prof-sections__email"></p>
                                        </span>
                                        <span class="premium-phones">
                                            <img src="/templates/A65/img/icons/planet.svg" alt=""><p class="prof-sections__addr"></p>
                                        </span>
                                    </section>
